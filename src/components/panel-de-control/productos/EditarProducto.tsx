...
export function EditarProducto(
    { categorias, productoPorDefecto, categoriaPorDefecto }:
        { categorias: Categoria[], productoPorDefecto: Producto, categoriaPorDefecto: Categoria }) {
    const [producto, setProducto] = useState<Producto>(productoPorDefecto)
            ...
            <div className="grid gap-4 md:grid-cols-[1fr_250px] lg:grid-cols-3 lg:gap-8">
                <div className="grid auto-rows-max items-start gap-4 lg:col-span-2 lg:gap-8">
                    ...
                    <SelectorDeCategorias
                        ...
                        valoresPorDefecto={{ c: categoriaPorDefecto, sc: producto.subCategoria }}
                        ...
                        <CardContent>
                            <div className="grid gap-6">
                                <div className="grid gap-3">
                                    ...
                                    <Select defaultValue={producto.estado} onValueChange={(e) => setProducto(prev => { return { ...prev, estado: e } })}>
                        ...
                        <CardContent>
                            <SubirFoto
                                borrarImg={(url: string) => setProducto(prev => {
                                    return { ...prev, imgs: prev.imgs.filter((img) => img != url) }
                                })}
                                imgs={producto.imgs}
                                agregarImg={(url: string) => setProducto(prev => { return { ...prev, imgs: [...prev.imgs, url] } })} />
